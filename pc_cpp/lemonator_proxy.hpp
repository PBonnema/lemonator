...
public:
   serial_port(int p, bool log_transactions, bool log_characters) : p(p), log_transactions(log_transactions), log_characters(log_characters)
   {
...
public:
   lemonator_proxy(
       ...
       bool log_characters = 0) : lemonator_interface(p_lcd,
                                                      p_keypad,
                                                      p_distance,
                                                      p_color,
                                                      p_temperature,
